...
CREATE TABLE IF NOT EXISTS TRIAGEM( 
  IDTRIAGEM INT(11) AUTO_INCREMENT PRIMARY KEY, 
...
ALTER TABLE TRIAGEM ADD CONSTRAINT FK_ID_TRIAGEM_PAC FOREIGN KEY(IDPAC) REFERENCES PACIENTE(IDPACIENTE) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE TRIAGEM ADD CONSTRAINT FK_ID_TRIAGEM_ATEND FOREIGN KEY(IDATEND) REFERENCES ATENDIMENTO(IDATENDIMENTO) ON DELETE CASCADE ON UPDATE CASCADE;